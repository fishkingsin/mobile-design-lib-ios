...
final class UpcomingVideoViewTest: XCTestCase {
  ...
  class MockUpcomingItem: VideoDisplayable {
    ...
    init(
      imageURL: String? = nil, headline: String? = nil, leadingFootnote: String? = nil,
      secondFootnote: String? = nil, id: Int? = nil, url: String? = nil, videoType: String? = nil
    ) {
