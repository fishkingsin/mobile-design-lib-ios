...
>: View {
    ...
    public init(imageUrl: String, imageWidth: CGFloat?, imageHeight: CGFloat?, placeholderView: @escaping () -> PlaceholderView, contentView: @escaping () -> ContentView, overlayView: ( () -> OverlayView)? = nil) {
