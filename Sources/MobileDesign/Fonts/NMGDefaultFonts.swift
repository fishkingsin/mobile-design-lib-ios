...
open class NMGDefaultFonts: NMGThemeableFonts {
    ...
    open var cardTitle: UIFont{.systemFont(ofSize: 16, weight: .semibold)}
    open var cardContent: UIFont{.systemFont(ofSize: 14, weight: .regular)}
    
    open var articleH1: UIFont{.systemFont(ofSize: 26, weight: .semibold)}
    open var articleH2: UIFont{.systemFont(ofSize: 24, weight: .semibold)}
    open var articleH3: UIFont{.systemFont(ofSize: 20, weight: .semibold)}
    open var articleContent: UIFont{.systemFont(ofSize: 20, weight: .regular)}
